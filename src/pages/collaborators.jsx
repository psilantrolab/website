            ...
            <div className="container" style={{minHeight:'65vh'}}>
                <div className="row justify-content-center">
                    <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mt-5">
                        ...
                        Mexico
                        <ul>
                            <li><a target="_blank"  href="http://personal.inb.unam.mx/lconcha/">Luis Concha, MD, PhD</a>, Brain Connectivity Lab, Institute of Neurobiology, UNAM.</li>
                            <li><a target="_blank"  href="https://scholar.google.com/citations?user=fAzVWFQAAAAJ&hl=en">Sarael Alcauter-Solorzano, PhD</a>, Brain Mapping Lab, Institute of Neurobiology, UNAM.</li>
                            <li><a target="_blank"  href="http://132.248.142.23/web_site/home_pages/27">Fernando A. Barrios, PhD</a>, Brain Mapping Lab, Institute of Neurobiology, UNAM.</li>
                            <li><a target="_blank"  href="https://scholar.google.com.mx/citations?user=XJ15liMAAAAJ&hl=es">Ruth Alcalá-Lozano, MD, MSc</a>, Instituto Nacional de Psiquiatría “Ramón de la Fuente Muñiz”.</li>
                            <li><a target="_blank"  href="https://scholar.google.com.mx/citations?user=4rbm3UYAAAAJ&hl=en">Alberto Camacho-Morales, PhD</a>, Universidad Autónoma de Nuevo León.</li>
                        </ul>
                    </div>
                </div>
            </div>
