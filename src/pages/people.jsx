            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mt-5">
                ...
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="card-footer"><a href="https://egarza.github.io/"> Personal Website</a> - <a href="https://github.com/egarza">Github</a>  - <a href="https://twitter.com/egarzav">Twitter</a>  - <a href="https://www.researchgate.net/profile/Eduardo_Garza_Villarreal">ResearchGate</a>  - <a href="https://scholar.google.com/citations?user=bX502bUAAAAJ&hl=en">Google Scholar</a>  - <a href="https://osf.io/uc6aj/"> OSF</a> - <a href="https://orcid.org/0000-0003-1381-8648">ORCID</a></div>
                    </div>
                </div>
                <h3>PhD students</h3>
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                ...
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Diego E Diego E. Ortuzar-Martínez, BSc, Neurobiology</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">Ph.D. Student, Faculty of Medicine, Universidad Autónoma de Nuevo León. Supervisor: <a href="https://scholar.google.com.mx/citations?user=4rbm3UYAAAAJ&hl=en">Alberto Camacho</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">Ph.D. Student, Faculty of Psychology, UNAM. Supervisor: <a href="http://psicologia.posgrado.unam.mx/juan-jose-sanchez-sosa/">Juan José Sanchez Sosa</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text">Ph.D. Student, Center for Music in the Brain, University of Aarhus, Denmark. Supervisor: <a href="https://scholar.google.com/citations?user=DkKlEL0AAAAJ&hl=en&oi=ao">Peter Vuust</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Arun Garimella, Computer Sciences (Currrently RA at Computational Neuroscience </h5>
                                <p className="card-text">Labs, <strong>ATR Institute International</strong>, Kyoto, Japan</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Sofia Sofia Fernandez, M.Sc. (Currently <strong>PhD student</strong> at Louis Collins Lab in <strong>McGill University</strong>)</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Sigrid Lunde, Ph.D. (Currently <strong>PostDoc</strong> at the Department of Psychology and Behavioral Sciences in <strong>University of Aarhus</strong>)</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Viviana Villicaña, B.A. (Currently <strong>MSc student</strong> at NeuroBIM-Bordeaux International Master of Neurosciences in <strong>University of Bordeaux</strong>)</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Josue Josue Mendoza, B.A. (Currently: <strong>Specialty</strong> in Applied Statistics from the <strong>IMAS UNAM</strong>)</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="card mb-3" style={{maxWidth:'540px'}}>
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title">Pamela Pamela Palacios, M.Sc. (Currently: <strong>Psychological Examiner</strong> at <strong>St. Jude Children’s Research Hospital Memphis, Tennessee</strong>)</h5>
                            </div>
                        </div>
                    </div>
                </div>
