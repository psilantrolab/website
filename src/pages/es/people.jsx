                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Estudiante de Doctorado, Facultad de Medicina, Universidad Autónoma de Nuevo León. Supervisor: <a target="_blank" rel="noreferrer"  href="https://scholar.google.com.mx/citations?user=4rbm3UYAAAAJ&hl=en">Alberto Camacho</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Estudiante de Doctorado, Facultad de Psicología, UNAM. Supervisor: <a target="_blank" rel="noreferrer"  href="http://psicologia.posgrado.unam.mx/juan-jose-sanchez-sosa/">Juan Jos&eacute; S&aacute;nchez Sosa</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Estudiante de Doctorado, Center of Music in the Brain, Universidad de Aarhus, Dinamarca. Supervisor: <a target="_blank" rel="noreferrer"  href="https://scholar.google.com/citations?user=DkKlEL0AAAAJ&hl=en&oi=ao">Peter Vuust</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
