            ...
            <div className="container" style={{minHeight:'65vh'}}>
                <div className="row justify-content-center">
                    <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 mt-5">
                        ...
                        M&eacute;xico
                        <ul>
                            <li><a target="_blank" rel="noreferrer"  href="http://personal.inb.unam.mx/lconcha/">Dr. Luis Concha</a>, Laboratorio de Conectividad Cerebral, Instituto de Neurobiología, UNAM</li>
                            <li><a target="_blank" rel="noreferrer"  href="https://scholar.google.com/citations?user=fAzVWFQAAAAJ&hl=en">Dr. Sarael Alcauter Solorzano</a>,  Laboratorio de Mapeo Cerebral, Instituto de Neurobiología, UNAM.</li>
                            <li><a target="_blank" rel="noreferrer"  href="http://132.248.142.23/web_site/home_pages/27">Dr. Fernando A. Barrios</a>, Laboratorio de Mapeo Cerebral, Instituto de Neurobiología, UNAM.</li>
                            <li><a target="_blank" rel="noreferrer"  href="https://scholar.google.com.mx/citations?user=XJ15liMAAAAJ&hl=es">Dra. Ruth Alcalá-Lozano</a>, Instituto Nacional de Psiquiatría “Ramón de la Fuente Muñiz”.</li>
                            <li><a target="_blank" rel="noreferrer"  href="https://scholar.google.com.mx/citations?user=4rbm3UYAAAAJ&hl=en">Dr. Alberto Camacho-Morales</a>, Universidad Autónoma de Nuevo León.</li>
                        </ul>
                    </div>
                </div>
            </div>
